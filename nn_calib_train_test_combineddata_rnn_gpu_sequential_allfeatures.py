...
INCLUDE_TIME_IN_SIMULATION = False
USE_RNN = False

#OUTPUT_FILENAME = 'results_simulations_all.csv'
#OUTPUT_FILENAME = 'results_simulations_all_with_rnn.csv'
#OUTPUT_FILENAME = 'results_simulations_without_date_with_rnn.csv'
OUTPUT_FILENAME = 'results_simulations_without_date_without_rnn.csv'
hidden_size_lstm = 64
hidden_size_fc1 = 32
hidden_size_fc2 = 16
...
def process_column(column_name_to_delete, df, n_simulations):
    ...
    np.savetxt(OUTPUT_FILENAME, metrics_list, delimiter=',', header=header, comments='')
...
def main():
    ...
    result = process_column("All included", df, n_simulations)
    if result:
